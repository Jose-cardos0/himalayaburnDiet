...
const Home: React.FC = () => {
  return (
    <section className="min-h-screen flex flex-col items-center justify-center m-auto bg-feminine-gradient">
      ...
      <div className="text-center space-y-8 px-6">
        ...
        <div className="relative flex justify-center items-center">
          <div className="absolute inset-0 bg-gradient-to-r from-pink-200 to-purple-200 rounded-full blur-2xl opacity-100 animate-pulse"></div>
          <img
        ...
        {/* Botão de ação */}
        <Link to="/form">
          <button className="group relative px-8 mt-8 py-4 bg-gradient-to-r from-pink-400 to-purple-500 text-white font-semibold rounded-full text-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 hover:from-pink-500 hover:to-purple-600">
